                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-10">
                                <select name="jenis" class="form-control select2" required>
                                    ...
                                    <option value="3">APS UZUR/SAKIT</option>
                                    <option value="4">JANDA/DUDA/YATIM</option>
                                </select>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-block btn-primary"><strong>AJUKAN PENSIUN</strong></button>
                            </div>
                            </div>
                        </div>
                    </div>
