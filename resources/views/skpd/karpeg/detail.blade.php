...
@endsection
@section('content')
<a href="/admin/karpeg" class="btn btn-sm bg-gradient-purple"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a><br/><br/>
<div class="row">
    <div class="col-12">
    ...
    <div class="col-12">
            ...
            <div class="card-body table-responsive p-0">
                ...
                <tbody>
                    ...
                    <tr style="font-size:11px; font-family:Arial, Helvetica, sans-serif">
                        ...
                        <td>
                            <button type="button" class="btn btn-xs upload btn-primary" data-penamaan="STTPL" data-field="sttpl">Upload</button>
                        </td>  
                    </tr>
                    ...
                    <tr style="font-size:11px; font-family:Arial, Helvetica, sans-serif">
                        ...
                        <td>
                            <button type="button" class="btn btn-xs upload btn-primary" data-penamaan="SPMT" data-field="spmt">Upload</button>
                        </td>  
                    </tr>
        ...
        <a href="/admin/karpeg/{{$id}}/kirim" class="btn btn-sm btn-block btn-danger" onclick="return confirm('Yakin Sudah Selesai Semua?')"> <i class="fas fa-paper-plane"></i> <strong>Validasi & Kirim Ke BKD</strong></a><br/>
    </div>
</div>
