...
@endsection
@section('content')
<a href="/admin/karsu" class="btn btn-sm bg-gradient-purple"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a><br/><br/>
<div class="row">
    <div class="col-12">
        <form method="post" action="/admin/karsu/create">
            @csrf
            <div class="row">
    ...
    <div class="col-12">
            ...
            <div class="card-body table-responsive p-0">
                ...
                <tbody>
                    ...
                    <tr style="font-size:11px; font-family:Arial, Helvetica, sans-serif">
                        ...
                        <td>
                            <button type="button" class="btn btn-xs upload btn-primary" data-penamaan="LKP" data-field="lkp">Upload</button>
                        </td>  
                    </tr>
                    <tr style="font-size:11px; font-family:Arial, Helvetica, sans-serif">
                        <td>3</td>
        ...
        <a href="/admin/karsu/{{$id}}/kirim" class="btn btn-sm btn-block btn-danger" onclick="return confirm('Yakin Sudah Selesai Semua?')"> <i class="fas fa-paper-plane"></i> <strong>Validasi & Kirim Ke BKD</strong></a><br/>
    </div>
</div>
...
<div class="modal fade" id="modal-upload" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form method="post" action="/admin/karsu/{{$id}}" enctype="multipart/form-data">
            @csrf
